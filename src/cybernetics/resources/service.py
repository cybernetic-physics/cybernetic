...
from ..types.get_scheduler_state_response import GetSchedulerStateResponse
...
class AsyncServiceResource(AsyncAPIResource):
    async def get_scheduler_state(
        ...
        *,
        ...
        """Retrieves current scheduler state and queue depths."""
        return await self._get(
            "/api/v1/get_scheduler_state",
            ...
            cast_to=GetSchedulerStateResponse,
        )
