...
class BasePage(GenericModel, Generic[_T]):
    ...
    def next_page_info(self) -> Optional[PageInfo]:
        raise NotImplementedError("Subclasses must implement next_page_info()")
    ...
    def __init__(
        ...
        *,
        ...
        if max_retries is None:  # pyright: ignore[reportUnnecessaryComparison]
            raise TypeError(
                "max_retries cannot be None. If you want to disable retries, pass `0`; if you want unlimited retries, pass `math.inf` or a very high number; if you want the default behavior, pass `cybernetics.DEFAULT_MAX_RETRIES`"
            )
...
class AsyncHttpxClientWrapper(DefaultAsyncHttpxClient):
    def __del__(self) -> None:
        ...
        try:
            ...
            # Best-effort cleanup during object finalization cannot safely surface errors.
            pass
