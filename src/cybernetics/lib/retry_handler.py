...
class RetryConfig:
    ...
    retryable_exceptions: tuple[Type[Exception], ...] = (
        ...
        cybernetics.APIConnectionError,
...
class RetryHandler(Generic[T]):  # noqa: UP046
        ...
        async with self._semaphore:
            ...
            try:
                ...
                if current_task._no_progress_made_marker:  # pyright: ignore[reportAttributeAccessIssue]
                    ...
                    raise cybernetics.APIConnectionError(
    ...
    def _should_retry(self, exception: Exception) -> bool:
        ...
        if isinstance(exception, cybernetics.APIStatusError):
    ...
    def _log_retry_reason(self, exception: Exception, attempt_count: int):
        ...
        elif isinstance(exception, cybernetics.APIConnectionError):
            logger.debug(f"Request failed with connection error: {exception}")
        elif isinstance(exception, cybernetics.APIStatusError):
            logger.debug(
