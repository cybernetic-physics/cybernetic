...
logger: logging.Logger = logging.getLogger("cybernetics")
httpx_logger: logging.Logger = logging.getLogger("httpx")


def _basic_config() -> None:
    # e.g. [2023-10-05 14:12:26 - cybernetics._base_client:818 - DEBUG] HTTP Request: POST http://127.0.0.1:4010/foo/bar "200 OK"
    logging.basicConfig(
...
def setup_logging() -> None:
    ...
    # log stream. The worldlines API server communicates backpressure
    ...
    env = os.environ.get("CYBERNETICS_LOG")
    if env == "debug":
        _basic_config()
