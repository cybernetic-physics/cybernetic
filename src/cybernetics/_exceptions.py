...
class CyberneticsError(Exception):
    """Base exception for all Cybernetics-related errors."""

    pass


class APIError(CyberneticsError):
...
class SidecarError(CyberneticsError):
...
class RequestFailedError(CyberneticsError):
