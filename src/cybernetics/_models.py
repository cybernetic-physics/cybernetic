...
def is_basemodel(type_: type) -> bool:
    ...
    if origin is Union or origin is UnionType:
        variants = get_args(type_) or ()
        return any(is_basemodel(variant) for variant in variants)
...
def construct_type(*, value: object, type_: object, metadata: Optional[List[Any]] = None) -> object:
    ...
    if origin is Union or origin is UnionType:
        try:
            ...
            # Fall through to discriminated-union and best-effort variant construction.
            pass
