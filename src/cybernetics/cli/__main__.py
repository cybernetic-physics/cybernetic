"""Cybernetics CLI - Command-line interface for the Cybernetics SDK.
...
Enable execution of the CLI via python -m cybernetics.cli
"""
...
def main():
    try:
        main_cli()
    except CyberneticsCliError as e:
